...
//        #pragma config PLLDIV   = 3         // (12 MHz crystal on PICDEM FS USB board)
        ...
        #pragma config CPUDIV   = OSC1_PLL2 // 4MHZ when FOSC == XT_XT
// PEB 20130327        #pragma config CPUDIV   = OSC1_PLL2	 // 48MHZ when FOSC=XTPLL

        #pragma config USBDIV   = 2         // Clock source from 96MHz PLL/2

//        #pragma config FOSC     = HSPLL_HS   // xtal

// PEB 20130327        #pragma config FOSC     = XTPLL_XT   // resonator and PLL
// CPU clock not from PLL, right from XT
        #pragma config FOSC     = XT_XT   // resonator no PLL
...
//      #pragma config CCP2MX   = ON
        #pragma config STVREN   = ON        // stack overflow enable
